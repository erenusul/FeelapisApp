...
export default function PurchaseScreen({ route, navigation }) {
  ...
  const handleBuy = () => {
    ...
    Alert.alert(
      'Başarılı',
      `${product.name} ürününden ${quantity} adet satın alındı.\nÖdeme kartı: ${selectedCard.name}`,
      [
        {
          text: 'Tamam',
          onPress: () => {
  ...
  return (
    <View style={styles.container}>
      {/* Başlık ve ürün görseli yan yana */}
...
const styles = StyleSheet.create({
  ...
  header: {
    ...
    alignItems: 'flex-end', // görsel biraz aşağıda olacak
    marginBottom: 20,
  },
  ...
  title: {
    ...
    borderBottomWidth: 2,
    paddingBottom: 8,
    marginTop: 50 // başlık biraz aşağıda
  },
  ...
  productImage: {
    ...
    height: 170,
    borderRadius: 16,
    marginBottom: 5, // biraz aşağıya kaydırdık
    position: 'absolute',
    top: 70,      // yukarıdan 80 birim aşağı
    right: 4,   
},
